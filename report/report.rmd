...
In this sense, we want the particles in the Hamiltonian system to only move around inside the constrained space and may also hit the 'wall', in which $\textbf{F}\textbf{x} + \textbf{g} = 0$. The distribution 
